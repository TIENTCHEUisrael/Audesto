...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/orther/model.css">
    <!-- Google Fonts -->
...
<body>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="../car/model.html" class="active">
    ...
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">New Model</h5>
    
                  <!-- Multi Columns Form -->
                  <form class="row g-3">
                    <div class="col-md-12">
                      <label for="inputName5" class="form-label">Name</label>
                      <input type="text" class="form-control" id="inputName5"placeholder="Name of model">
                    </div>
                    
                    <div class="col-md-12">
                      <label for="inputEmail5" class="form-label">Description</label>
                      <input type="email" class="form-control" id="inputEmail5" style="height: 100px;" placeholder="Place your description">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" id="inputAddres5s" placeholder="Title of model">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col md-3">
                        ...
                        <input type="number" class="form-control" placeholder="Number of Door">
                    </div>
                     <div class="col md-2">
                        <label for="inputNumber" class="col-sm-2 col-form-label">P</label>
                        <input type="number" class="form-control" placeholder="Number of Places">
                    </div>                    
