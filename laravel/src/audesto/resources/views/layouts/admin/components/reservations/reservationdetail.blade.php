      ...
      <section class="section">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Multi Columns Form -->
            <form class="row g-3" action="{{ route('Administrateur.updatereservation')}}" method="post">
              @csrf
              <div class="col-md-12">
                ...
                <input type="text" name="idd" class="form-control" value="{{$res[0]->id}}" hidden>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" value="{{$res[0]->date_recup}}" type="datetime-local" readonly />
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" value="{{$res[0]->montant}}" type="text" placeholder="Montant de la reservation" readonly />
              </div>
              <div class="col-md-6">
                <label for="inputState" class="form-label">Voiture</label>
                <select id="inputState" name="voiture" class="form-select">
                  @foreach($voi as $v)
